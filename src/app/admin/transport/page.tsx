...
export default function TransportManagement() {
  const [transport, setTransport] = useState([
    ...
    {
      id: '2',
      name: 'Van for Large Equipment',
      description: 'Cargo van for large equipment transport',
      dailyRate: 800000,
      quantity: 1
    },
    {
      id: '3',
      name: 'Luxury Sedan',
      description: 'Premium sedan for client transportation',
      dailyRate: 1500000,
      quantity: 3
    }
  ])
  ...
  const saveTransport = () => {
    if (editingTransport) {
      ...
      setTransport(transport.map(item => 
        item.id === editingTransport.id ? newTransport : item
      ))
    } else {
      // Add new transport
      setTransport([
        ...transport,
        { ...newTransport, id: `${transport.length + 1}` }
      ])
    }
    closeModal()
  }
                      ...
                      <div className="mt-4 space-y-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            name="dailyRate"
                            id="dailyRate"
                            value={newTransport.dailyRate}
                            onChange={(e) => setNewTransport({...newTransport, dailyRate: parseInt(e.target.value) || 0})}
                            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setNewTransport({...newTransport, quantity: parseInt(e.target.value) || 0})}
                            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                          />
                        </div>
                      </div>
