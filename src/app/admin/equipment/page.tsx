...
export default function EquipmentManagement() {
  const [equipment, setEquipment] = useState([
    ...
    },
    {
      id: '3',
      name: 'Tripod',
      description: 'Carbon fiber professional tripod',
      dailyRate: 100000,
      quantity: 10
    }
  ])
  ...
  const saveEquipment = () => {
    if (editingEquipment) {
      ...
      setEquipment([
        ...equipment,
        { ...newEquipment, id: `${equipment.length + 1}` }
      ])
    }
    closeModal()
  }
                      ...
                      <div className="mt-4 space-y-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setNewEquipment({...newEquipment, dailyRate: parseInt(e.target.value) || 0})}
                            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                          />
                        </div>
                        <div>
