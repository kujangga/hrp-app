...
export default function PhotographerPage() {
  ...
  const photographerItems = [
    ...
    },
    {
      ...
      price: 'Rp 4,200,000/day',
      rating: 5.0,
      completedProjects: 320,
      features: ['Editorial Experience', 'Fashion Week Expert', 'Model Direction', 'Post-Production'],
      description: 'High-fashion photographer with international editorial and runway experience.'
    },
    {
      id: 4,
      name: 'David Kusuma',
      ...
      features: ['E-commerce Ready', 'White Background', '360° Views', 'Fast Turnaround'],
      description: 'Specialized in product photography for e-commerce and advertising campaigns.'
    },
    {
      id: 5,
      name: 'Lisa Rahman',
      ...
      features: ['Multi-Camera Setup', 'Live Coverage', 'Quick Edits', 'Social Media Ready'],
      description: 'Expert event photographer capturing corporate events, conferences, and parties.'
    },
    {
      id: 6,
      name: 'James Lee',
      ...
      features: ['Sunrise/Sunset Specialist', 'HDR Photography', 'Print Quality', 'Travel Ready'],
      description: 'Nature and landscape photographer creating stunning scenic and travel imagery.'
    }
  ]

  const specializationCategories = [
    { id: 'all', name: 'All Photographers' },
    ...SPECIALIZATIONS.map(spec => ({ id: spec.name.toLowerCase(), name: spec.name }))
  ]

  const filteredPhotographers = photographerItems.filter(item => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Full Photographer Inventory Section */}
      <section id="inventory" className="py-16 px-4 lg:py-24 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            ...
            >
              Browse our complete portfolio of professional photographers
            </motion.p>
          </div>
              ...
              >
                <div className="p-6">
                  ...
                  <div className="mb-3 flex items-center gap-2">
                    <div className="flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`h-3.5 w-3.5 ${i < Math.floor(photographer.rating) ? 'fill-[#7D97B6] text-[#7D97B6]' : 'text-gray-300'}`} />
                      ))}
                    </div>
                    <span className="text-sm font-semibold" style={{ color: COLORS.NAVY_DARK }}>{photographer.rating}</span>
                    <span className="text-xs" style={{ color: COLORS.SLATE_MEDIUM }}>({photographer.completedProjects} projects)</span>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1">
                      {photographer.features.slice(0, 3).map((feature, idx) => (
